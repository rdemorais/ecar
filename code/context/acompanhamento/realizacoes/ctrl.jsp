...
<input type="hidden" name="codArisControle" value="<%=codArisControle%>">
...
<%
	...
	try{
			...
			if("incluir".equals(hidAcao)){
				...
				submit = "eventos.jsp?codArisControle="+ codArisControle + "&hidFormaVisualizacaoEscolhida=" + formaVisualizacaoControle + "&codTipoAcompanhamento=" + codTipoAcompanhamento;
			...
			if("excluir".equals(hidAcao)){
				...
				submit = "eventos.jsp?hidFormaVisualizacaoEscolhida=" + formaVisualizacaoControle + "&codTipoAcompanhamento=" + codTipoAcompanhamento;;

...
<%
	...
	//List lista = itemEstPrevDao.getListaItemEstruturaPrevisao(acompReferenciaItem.getItemEstruturaIett(), null);
...
<%
	...
	if (it.hasNext()){
		...
		while(itExerc.hasNext()){
			...
			List lista = itemEstPrevDao.getListaItemEstruturaPrevisao(acompReferenciaItem.getItemEstruturaIett(), exercicio);		
			it = lista.iterator();
			int cont = 0;

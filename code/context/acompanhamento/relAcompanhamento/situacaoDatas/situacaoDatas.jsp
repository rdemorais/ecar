...
<table border="0" cellpadding="0" cellspacing="0" width="100%">	
	<tr>						
			...
			<tr class="linha_subtitulo">
				...
				<td width="40%" colspan="2"><%=abaDao.getLabelAbaEstrutura(aba, acompReferenciaItem.getItemEstruturaIett().getEstruturaEtt()) %> </td>
				<td width="30%"></td>
				<% //luana
...
%>
			<tr class="cor_sim" onmouseover="javascript:destacaLinha(this,'over','')" onmouseout="javascript: destacaLinha(this,'out','cor_sim')" onClick="javascript: destacaLinha(this,'click','cor_sim')">
				...
				%>
					<table>
						<tr class="cor_sim" onmouseover="javascript:destacaLinha(this,'over','')" onmouseout="javascript: destacaLinha(this,'out','cor_sim')" onClick="javascript: destacaLinha(this,'click','cor_sim')">
							<td><%=imgNivel%><img align="right" src="<%=_pathEcar%>/images/icon_bullet_seta.png" onclick="javascript:agruparPontosCriticosItem('iett_<%=iett.getCodIett()%>')"></td>
				...
				<% //aqui começa as sub-linhas
					if(iett.getPontoCriticoPtcs() != null && iett.getPontoCriticoPtcs().size() > 0){
						...
						<table width="100%" id="<%="iett_" + iett.getCodIett()%>" >
							...
							<tr class="label">
								<td width="40%">&nbsp;</td>
								<td width="30%" colspan="2" align="left">Descrição</td>
								<td width="10%" align="center" nowrap>Tipo/Assunto</td>

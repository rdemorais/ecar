...
<%
	...
	if(codigo != null && !"".equals(codigo)){
		...
		String caminhoArquivo = configuracao.getRaizUpload() + item.getArquivoIettup();
		String tagHtml;
		...
		if (item.getUploadTipoArquivoUta().getUploadTipoCategoriaUtc().getCodUtc().longValue() == 1) { //Imagem
			...
			tagHtml += "<BR><BR>Clique na imagem para ampliá-la";
		...
		out.println("<br><br><br>Selecione um item do menu ao lado para visualização");
	}
	out.println("</center>");
%>
<br>

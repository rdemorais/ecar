...
out.println("#item" + x + " {");
out.println("	background-image: url(../images/estilo/icone_menu_mais_gd_"+configuracaoMenu.getEstilo().getNome()+".gif);");
out.println("	background-repeat: no-repeat;");
out.println("	background-color: #F7F3DE;");
out.println("	font-family: Verdana, Arial, Helvetica, sans-serif;");
out.println("	font-size: 10px;");
out.println("	display:block;");
out.println("	border: 1px solid #C8A040;");
out.println("	margin:1px;");
out.println("	width: 166px;");
out.println("}");
out.println("#item" + x + " a{");
out.println("	color: #634601;");

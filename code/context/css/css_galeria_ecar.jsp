...
for(int x = 0; x <= listaUtc.size(); x++){
	...
	out.println("border-top: 1px solid #CED7E7; border-left: 1px solid #CED7E7;");
	out.println("border-right: 1px solid #CED7E7; padding: 5px; z-index: 1;");
	out.println("}");
	out.println("#anexotipomenu"+x+".aberto{");
	out.println("border-top: 1px solid #CED7E7; border-left: 1px solid #CED7E7;");
	out.println("border-right: 1px solid #CED7E7; padding: 5px; z-index: 1;");
	out.println("background-color: #EAEEF4;");
	out.println("}");
	...
	out.println("color:	#1C2265; text-decoration: none; padding-left: 15px;");
	out.println("}");

...
<div id="conteudo"> 
	...
	if(tipoAcompanhamento.getEstruturaEtt() != null && acompReferenciaItem.getItemEstruturaIett() != null && acompReferenciaItem.getItemEstruturaIett().getItemEstruturaIett() != null){
		telaAnt = _pathEcar + "/relAcompanhamento/proximosItens.jsp?itemDoNivelClicado=" + acompReferenciaItem.getItemEstruturaIett().getItemEstruturaIett().getCodIett() + "&codTipoAcompanhamento=" + Pagina.getParamStr(request, "codTipoAcompanhamento") + "&hidFormaVisualizacaoEscolhida="+Pagina.getParamStr(request, "hidFormaVisualizacaoEscolhida")+ "#ancora" + acompReferenciaItem.getItemEstruturaIett().getCodIett();
	}
	else{
		telaAnt = _pathEcar + "/relAcompanhamento/posicaoGeral.jsp?fecharMenu=true&titulo=Geral&codTipoAcompanhamento=" + Pagina.getParamStr(request, "codTipoAcompanhamento") + "&hidFormaVisualizacaoEscolhida="+Pagina.getParamStr(request, "hidFormaVisualizacaoEscolhida")+ "#ancora" + acompReferenciaItem.getItemEstruturaIett().getCodIett();
	}

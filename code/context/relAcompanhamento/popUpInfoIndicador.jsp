...
<form name="form">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="form">
		...
		<tr>
			<td class="label">Acumulável:</td><td><%=ePublico%></td>
		</tr>
		<tr>
		...
		<%
				...
				if (itExercicio.hasNext()) {
					while (itExercicio.hasNext()) {
						...
						if (indicador.getCodIettir() != null) {
							try {
								itemEstrutFisico = (ItemEstrutFisicoIettf) itemEstrutFisicoDao.buscar(indicador.getCodIettir(), exercicio.getCodExe());
							} catch (Exception e) {
		...
		%>				
						<tr>
							...
							<td align="center" class="texto">
								<%=Pagina.trocaNullNumeroDecimal(itemEstrutFisico.getQtdPrevistaIettf())%>
							</td>
							<td class="texto"></td>
						</tr>
		<%

		...
		<tr> 
			...
			if(mostraGrafico){
				...
				<table>
					...
					<%	
						String textoCorVerde = "";
						String textoCorAmarelo = "";
						String textoCorVermelho = "";
						CorDao corDao = new CorDao(request); 
				
						List listCores = corDao.listar(Cor.class, null);
				        Iterator itCores = listCores.iterator();
				        while(itCores.hasNext()){
				            ...
				            if(cor.getCodCor().longValue() == 1) {
								textoCorVerde = cor.getSignificadoCor();
							}
							else if(cor.getCodCor().longValue() == 2) {
								textoCorAmarelo = cor.getSignificadoCor();
							}
							else if(cor.getCodCor().longValue() == 3) {
								textoCorVermelho = cor.getSignificadoCor();
							}			
				        } 
				    %>
							<tr>
								<td align="center">Ciclos</td>
								<td align="center"><%=textoCorVerde%></td>
								<td align="center"><%=textoCorAmarelo%></td>
								<td align="center"><%=textoCorVermelho%></td>
				            	<td align="center">Não informado </td>
				            	<td align="center">Não Liberado (N/L)</td>

...
<jsp:directive.page import="ecar.email.AgendadorEmail"/>
<jsp:directive.page import="ecar.dao.TempCargaIettsBDDao"/>
<jsp:directive.page import="ecar.dao.TempCargaEcarDFIettsBDDao"/>
<jsp:directive.page import="ecar.bean.CargaFinalidadesPPA"/><%@ include file="/login/validaAcesso.jsp"%>
<%@ include file="/frm_global.jsp"%>

<%@ page import="ecar.dao.TempAtualizacaoBDDao" %>
...
<%@ page import="ecar.dao.TempCargaEcarDFIettsBDDao" %>
	<%
		try {
			TempCargaEcarDFIettsBDDao cargaIettsBdDao = new TempCargaEcarDFIettsBDDao(request);
			cargaIettsBdDao.efetuarCargaItens();
	...
	<form name="form" method="post" action="tempAtualizacaoBD.jsp">

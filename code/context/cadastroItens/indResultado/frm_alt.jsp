					...
					<%} %>
						<td width="100%" valign="top">
							...
							<%
								...
								String _msgPrevQtdePorLocal = "* " + _msg.getMensagem("itemEstrutura.indResultado.alteracao.existeEmPrevisto");
								...
								String existeAcompRealFisico = "";
								String existePrevistos = "";
								
								if(itemEstrtIndResulDao.verificarExistenciaEmAcompRealFisicoArf(itemEstrtIndResul)){
									_disabledQtdePorLocal = "disabled";
									existeAcompRealFisico = "S";
									
							    }
								else
								{
									existeAcompRealFisico = "N";									
								}

								
								if(itemEstrtIndResulDao.verificarExistenciaEmPrevistos(itemEstrtIndResul)){
								...
								String nivelAbrangencia = "";
								
								if (itemEstrtIndResul.getNivelAbrangencia() != null)
								{								
								      nivelAbrangencia = itemEstrtIndResul.getNivelAbrangencia().toString();
								}
								
								String previstoPorLocal ="";
								
								if (itemEstrtIndResul.getIndPrevPorLocal() != null){
									previstoPorLocal = itemEstrtIndResul.getIndPrevPorLocal(); 
							...
							%>
								...
								<input type="hidden" name="existeAcompRealFisico" id="existeAcompRealFisico" value="<%=existeAcompRealFisico%>">
								<input type="hidden" name="existePrevistos" id="existePrevistos" value="<%=existePrevistos%>">
                                <input type="hidden" name="nivelAbrangencia" id="nivelAbrangencia" value="<%=nivelAbrangencia%>">								
                                <input type="hidden" name="previstoPorLocal" id="previstoPorLocal" value="<%=previstoPorLocal%>">

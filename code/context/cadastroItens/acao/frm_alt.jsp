...
{
	//COMENTADO PORQUE O EVENTO APENAS ACONTECE NA INCLUSAO E EXCLUSAO DE EVENTOS
	//if(document.form.enviaEmailAtivo.value == 'S') {
	//	if(document.form.obrigatorio.value == 'S' || (document.form.obrigatorio.value == 'N' && confirm('<%=_msg.getMensagem("acompanhamento.cadastroItens.eventos.alteracao.autorizaEnviaEmail")%>') == true )) {
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<%} %>
						<td width="100%" valign="top">
							<util:arvoreEstruturas itemEstrutura="<%=itemEstrutura%>" contextPath="<%=_pathEcar%>" seguranca="<%=seguranca%>" idLinhaCadastro="<%=Pagina.getParamStr(request,"ultimoIdLinhaDetalhado") %>"/>

					...
					<%} %>
						<td width="100%" valign="top">
							...
							<%
								...
								ItemEstrutEntidadeIettePK chave = new ItemEstrutEntidadeIettePK(itemEstrutura.getCodIett(), Long.valueOf(Pagina.getParamInt(request, "codEnt")), Long.valueOf(Pagina.getParamStr(request, "codTpp")));

...
//COMENTADO PORQUE O EVENTO APENAS ACONTECE NA INCLUSAO E EXCLUSAO DE PONTOS CRITICOS	
...
<util:validacaoPontoCriticoTag atributos="<%=atributos%>" sisGrupoAtributoDao="<%= new SisGrupoAtributoDao(request)%>" acao="<%=ConstantesECAR.ACAO_ALTERAR%>" pontoCritico="<%=pontoCritico%>"/>
</script>
					...
					<%} %>
						<td width="100%" valign="top">
							...
							<%
								...
								if("S".equals(Pagina.getParamStr(request, "alterarPontoCritico"))){
									_disabledCampo = "disabled";
									_readonlyCampo = "readonly";
								}
							%>

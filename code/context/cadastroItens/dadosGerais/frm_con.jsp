...
<div id="conteudo">
	...
	<input type="hidden" name="obrigatorio" value="<%=configMailCfgmAlterarFuncAcomp.getIndEnvioObrigatorio()%>">
		...
		<% 
	// Rogério (28/03/2007). Mantis #9358.
	// Recebe o código de qual o ETT selecionado na tela anterior. Assim é possível retornar para a mesma aba.
	%>
	<input type="hidden" name="codEttSelecionado" id="codEttSelecionado" value="<%=Pagina.getParamStr(request, "codEttSelecionado")%>" >
	<% 
	// Rogério Fim Mantis #9358.
	%>
		...
		<tr>
			...
			<tr>
				...
				<td width="100%" valign="top">
					...
					/>
					<br><br>
					 <util:barrabotoes btn1="Alterar" exibirBtn1="<%=permissaoAlterar%>" btn4="Histórico" exibirBtn4="<%=new Boolean(permissaoExibirHistorico)%>" textoDireita="<%="( ID: "+itemEstrutura.getCodIett().toString()+" )"%>"/>

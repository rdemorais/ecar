...
<%
	...
	if(!"".equals(codIett)){
		UnidadeOrcamentariaUO unidadeSelecionada = ((ItemEstruturaIett) new ItemEstruturaDao(request).buscar(ItemEstruturaIett.class, Long.valueOf(codIett))).getUnidadeOrcamentariaUO();
		if(unidadeSelecionada != null){
			unidadeSel = unidadeSelecionada.getCodUo().toString();
		}
	}
%>

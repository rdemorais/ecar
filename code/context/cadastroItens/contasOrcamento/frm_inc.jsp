...
function carregaAjax(form, disabled){
	var url = "combo_fonteRecurso.jsp?disabled=" + disabled + "&exercicioExe=" + form.exercicioExe.value + "&codIett=" + form.codIett.value + "&fonteRecursoFonr=<%=Pagina.getParamStr(request, "fonteRecursoFonr")%>";
	openAjax(url, "comboFonteRec", null, null, true, "../../images");
	var url2 = "combo_recurso.jsp?disabled=" + disabled + "&exercicioExe=" + form.exercicioExe.value + "&codIett=" + form.codIett.value + "&fonteRecursoFonr=<%=Pagina.getParamStr(request, "fonteRecursoFonr")%>" + "&recursoRec=<%=Pagina.getParamStr(request, "recursoRec")%>";

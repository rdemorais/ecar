...
<%@page import="ecar.dao.ConfiguracaoDao"%><jsp:directive.page import="ecar.dao.EstruturaDao"/>
...
%>	
	...
	if (configura.getIndExibirArvoreNavegacaoCfg() != null && configura.getIndExibirArvoreNavegacaoCfg().equals("S")){

...
{
	//COMENTADO PORQUE O EVENTO APENAS ACONTECE NA INCLUSAO E EXCLUSAO DE ANEXO
	//if('<%=configMailCfgm.getAtivoCfgm()%>' == 'S') {
	//	if(document.form.obrigatorio.value == 'S' || (document.form.obrigatorio.value == 'N' && confirm('<%=_msg.getMensagem("acompanhamento.cadastroItens.anexo.alteracao.autorizaEnviaEmail")%>') == true )){
...
try{   
	...
	ItemEstrutUploadIettup anexo = (ItemEstrutUploadIettup) new ItemEstruturaUploadDao(request).buscar(ItemEstrutUploadIettup.class, Long.valueOf(Pagina.getParamStr(request, "cod")));
	ItemEstrUplCategIettuc categoriaAnexo = anexo.getItemEstrUplCategIettuc();
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					...
					<%} %>
						<td width="100%" valign="top">
							...
							<input type=hidden value="N" name="validarArquivo">	

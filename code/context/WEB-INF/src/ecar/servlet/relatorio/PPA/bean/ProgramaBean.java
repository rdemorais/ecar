...
/**
 * Classe pojo que representa a Fonte de dados de Item de programa para o relatorio PPA Projeto de Lei
...
public class ProgramaBean implements Serializable {
	...
	private static final long serialVersionUID = -2058805129035381680L;
	...
	/**
	 * Estrategia de Implementacao <item.getObjetivoGeralIett()>
	 */
	private String estrategiaImpl;
	...
	/**
	 * Objetivo do Programa <item.getObjetivoEspecificoIett()>
	 */
	private String objetivo;

	/**
	 * Justificativa <item.descricaoIett()>
	 */
	private String justificativa;
	
	/**
	 * Orgao responsavel <item.getOrgaoOrgByCodOrgaoResponsavel2Iett().getDescricaoOrg()>
	 */
	 ...
	 * Gestor do Programa
	 */
	private String gestorPrograma;
	
	/**
	 * Publico Alvo: <item.getDescricaoR2()>
	 */
	private String publicoAlvo;	
	
	/**
	 * Horizonte Temporal: Inicio <item.getDataInicioIett()>
	 */
	private Date inicio;
	
	/**
	 * Horizonte Temporal: Termino  <item.getDataTerminoIett()>
	 */
	private Date fim;
	...
	// tabela PPA - totalizador de programa
	...
	private ArrayList indicadores;
         ...
         * @return
         */
        public ArrayList getAcoes() {
		return acoes==null?new ArrayList():acoes; // se Null retorna Set vazio
	}
         ...
         * @param paramAcoes
         */
        public void setAcoes(ArrayList paramAcoes) {
		this.acoes = paramAcoes==null?new ArrayList():paramAcoes; // se Null retorna Set vazio
	}
         ...
         * @return
         */
        public String getGestorPrograma() {
		return gestorPrograma;
	}

        /**
         *
         * @param gestorPrograma
         */
        public void setGestorPrograma(String gestorPrograma) {
		...
		return totalCorrenteRecursoTot;
	}
         ...
         * @return
         */
        public String getEstrategiaImpl() {
		return estrategiaImpl;
	}

        /**
         *
         * @param estrategiaImpl
         */
        public void setEstrategiaImpl(String estrategiaImpl) {
		this.estrategiaImpl = estrategiaImpl;
	}

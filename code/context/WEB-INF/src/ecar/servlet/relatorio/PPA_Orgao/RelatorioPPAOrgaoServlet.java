...
/**
 * Servlet responsavel por interagir com os eventos de geracao de relatorio PPA por Orgao
 * @author gabrielsolana
 *
 */
public class RelatorioPPAOrgaoServlet extends RelatorioServlet {
	

	private static final long serialVersionUID = 5664707298670877576L;
	private Logger logger = Logger.getLogger(this.getClass());

        /**
         *
         */
        public RelatorioPPAOrgaoServlet(){
		super();
	}
		...
		logger.info("Generating relatorio PPA Por Orgao...");

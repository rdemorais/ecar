 ...
 *
 */
public class RevisaoItemEstrutura extends AbstractServletReportXmlXsl {
	...
	public StringBuffer getXml(HttpServletRequest request) throws ECARException{
        ...
        String tituloItens = "";
        String cabecalho = "Itens de Revisão da Estrutura do " + titulo;
    ...
    public void geraXMLItem(XmlBuilder builder, ItemEstruturaIett item, String orgao, List listaCriteriosCom, 
    		List listaCriteriosSem, List listaSituacoes) throws ECARException{

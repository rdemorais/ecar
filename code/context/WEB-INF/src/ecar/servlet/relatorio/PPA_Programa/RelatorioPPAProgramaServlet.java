 ...
 *
 */
public class RelatorioPPAProgramaServlet extends RelatorioServlet {
	
	private static final long serialVersionUID = 7044746259478772547L;
	private Logger logger = Logger.getLogger(this.getClass());

        /**
         *
         */
        public RelatorioPPAProgramaServlet(){
		super();
	}
		...
		logger.info("Generating relatorio PPA Por Programa...");
		...
		try {
			...
			final String pathRelPPA = context.getRealPath( JasperService.PATH_RELATORIO + "/relatorioPPAPrograma.jasper" );
			...
			ArrayList<PPA_ProgramaBean> relatorioDS = service.generatePPA();
			...
			logger.error( "Nao foi possivel gerar relatorio PPA por Programa",e);
		}

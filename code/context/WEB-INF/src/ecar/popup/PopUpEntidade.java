 ...
 *
 */
public class PopUpEntidade implements PopUpPesquisa {
    ...
    public List pesquisar() throws ECARException {
        entidade.setIndAtivoEnt("S");
        return entidadeDao.pesquisar(entidade, new String[] {"nomeEnt", "asc"});
    }
    ...
    public String getCodigo() {
        return entidade.getCodEnt().toString();
    }

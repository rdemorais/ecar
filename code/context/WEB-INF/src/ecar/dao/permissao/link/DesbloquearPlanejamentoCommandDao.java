 ...
 * @author 70744416353
 */
public class DesbloquearPlanejamentoCommandDao extends Dao implements PermissaoAcessoLinkCommand {
	 ...
	 */
	 public String execute(String evento, String parametros, SegurancaECAR seguranca, ServletContext servletContext) throws ECARException {
		...
		try {
			...
			url = URLEvento.montaURLRedirecionamento(Dominios.CFG_MAIL_DESBLOQUEAR_PLANEJAMENTO.toString(), parametros, servletContext);
		...
		/**
	     * Verifica a permissao de acesso do usuário da parte de cadastro
	     * 
                 * @param parametros
                 * @param seguranca

 ...
 * @author 70744416353
 */
public class DesativarMonitoramentoCommandDao extends Dao implements PermissaoAcessoLinkCommand {
	 ...
	 */
	 public String execute(String evento, String parametros, SegurancaECAR seguranca, ServletContext servletContext) throws ECARException {
		...
		try {
			...
			url = URLEvento.montaURLRedirecionamento(Dominios.CFG_MAIL_DESATIVAR_MONITORAMENTO.toString(), parametros, servletContext);

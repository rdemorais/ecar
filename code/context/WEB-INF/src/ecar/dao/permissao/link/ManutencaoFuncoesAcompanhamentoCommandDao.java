 ...
 * @author 70744416353
 */
public class ManutencaoFuncoesAcompanhamentoCommandDao
    extends Dao
    implements PermissaoAcessoLinkCommand
{
                   ...
                   throws ECARException
    {
        ...
        try
        {
            ...
            url = URLEvento.montaURLRedirecionamento( Dominios.CFG_MAIL_MANUTENCAO_FUNCOES_ACOMPANHAMENTO.toString(  ),
                                                      parametros,
                                                      servletContext );
        ...
        try {
                permissaoAcesso(parametros, seguranca);
                //        url = redirecionaParaCadastro(parametros, seguranca, resposta);

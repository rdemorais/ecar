 ...
 * @author 70744416353
 */
public class VencimentoDataReserva2CommandDao extends Dao implements PermissaoAcessoLinkCommand {
	 ...
	 */
	 public String execute(String evento, String parametros, SegurancaECAR seguranca, ServletContext servletContext) throws ECARException {
		...
		try {
			...
			url = URLEvento.montaURLRedirecionamento(Dominios.CFG_MAIL_DATA_RESERVA_2.toString(), parametros, servletContext);

 ...
 * @author 70744416353
 */
public class AlterarDatasLimitesRegistroFisicoCommandDao
    extends Dao
    implements PermissaoAcessoLinkCommand
{
                   ...
                   throws ECARException
    {
        ...
        try
        {
            ...
            url = URLEvento.montaURLRedirecionamento( Dominios.CFG_MAIL_ALTERAR_DATA_LIMITE_REGISTRO_FISICO.toString(  ),
                                                      parametros,
                                                      servletContext );
...
/*                        int posicao = 0;
                        ...
                        for(int i=0; i< valores.length; i++) {
                                ...
                                if(valores[i].contains("codAri")) {
                                        posicao =        valores[i].indexOf("=");
                                        codAri= valores[i].substring(posicao+1, (valores[i].length()));
                                }

                                if(valores[i].contains("itemDoNivelClicado")) {
                                        posicao =        valores[i].indexOf("=");
                                        itemDoNivelClicado= valores[i].substring(posicao+1, (valores[i].length()));
                                }

                                if(valores[i].contains("referencia_hidden")) {
                                        posicao =        valores[i].indexOf("=");
                                        referencia_hidden= valores[i].substring(posicao+1, (valores[i].length()));
                                }

                                if(valores[i].contains("periodo")) {
                                        posicao =        valores[i].indexOf("=");
                                        periodo= valores[i].substring(posicao+1, (valores[i].length()));
                                }

                                if(valores[i].contains("codUsuario")) {
                                        posicao =        valores[i].indexOf("=");
                                        codUsuario= valores[i].substring(posicao+1, (valores[i].length()));
                                }
                                ...
                                if(valores[i].contains("mesReferencia")) {
                                        posicao =        valores[i].indexOf("=");
                                        mesReferencia= valores[i].substring(posicao+1, (valores[i].length()));
                                }

                                if(valores[i].contains("codSrl")) {
                                        posicao =        valores[i].indexOf("=");
                                        codSrl= valores[i].substring(posicao+1, (valores[i].length()));
                                }
                        }

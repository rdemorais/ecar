 ...
 * @author 70744416353
 */
public class EventoManutencaoFuncaoAcompanhamento extends Evento{
	 ...
	 * Verificar forma melhor de implementar, que não seja pelo usando array.   
	 */
	public EventoManutencaoFuncaoAcompanhamento() {
		super(Dominios.CFG_MAIL_MANUTENCAO_FUNCOES_ACOMPANHAMENTO);   // Definido pelo desenvolvedor.

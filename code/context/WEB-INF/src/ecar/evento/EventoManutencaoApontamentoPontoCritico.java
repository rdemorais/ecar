 ...
 * @author 70744416353
 */
public class EventoManutencaoApontamentoPontoCritico extends Evento {
	 ...
	 * Verificar forma melhor de implementar, que não seja pelo usando array.   
	 */
	public EventoManutencaoApontamentoPontoCritico() {
		super(Dominios.CFG_MAIL_MANUTENCAO_APONTAMENTO);   // Definido pelo desenvolvedor.

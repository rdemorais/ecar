 ...
 * @author 70744416353
 */
public class EventoAlterarDatasLimitesRegistroFisico extends Evento {
	 ...
	 * Verificar forma melhor de implementar, que não seja pelo usando array.   
	 */
	public EventoAlterarDatasLimitesRegistroFisico() {
		super(Dominios.CFG_MAIL_ALTERAR_DATA_LIMITE_REGISTRO_FISICO);   // Definido pelo desenvolvedor.

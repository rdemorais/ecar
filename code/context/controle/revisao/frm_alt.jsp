...
try{
	...
	PeriodoRevisaoPrev prev = (PeriodoRevisaoPrev) prevDao.buscar(PeriodoRevisaoPrev.class, Long.valueOf(Pagina.getParamStr(request, "codPrev")));
%>
...
<form  name="form" method="post" >
	  <util:barrabotoes alterar="Alterar" voltar="Cancelar"/>
	<%
	_disabled = "";
	_readOnly = "readonly";
	%>

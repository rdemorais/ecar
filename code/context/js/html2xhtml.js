		...
		switch (child.nodeType) {
			case 1: { //ELEMENT_NODE
				...
				if (tag_name == '!') { //COMMENT_NODE in IE 5.0/5.5
					...
					if (tag_name == 'html') {
						text = '<?xml version="1.0" encoding="'+encoding+'"?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">';
					}
...
function fix_text(text) {
	...
	return String(text).replace(/\n{2,}/g, "").replace(/\&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\u00A0/g, "&nbsp;");
}

...
String exibirExcluirStr = (!"S".equals(indTabelaUso)) ? "true" : "false";
Boolean exibirExcluir = new Boolean(exibirExcluirStr);
%>
	...
	<body>
		...
		<div id="conteudo">
			...
			<form name="form" method="post" action="frm_nav.jsp">
				...
				grupoAtributo = (SisGrupoAtributoSga) lista.get(hidRegistro);
				%>

				<util:linkstop incluir="frm_inc.jsp" pesquisar="frm_pes.jsp" />
				<util:barrabotoes navegacao="true" btn1="Alterar" excluir="Excluir" exibirExcluir="<%=exibirExcluir%>" atual="<%=hidRegistro+1%>" total="<%=hidTotRegistro%>" />
				...
				Mensagem.alert(_jspx_page_context, _msg
						.getMensagem("erro.exception"));
...
%>
				...
				<util:barrabotoes navegacao="" btn1="Alterar" excluir="Excluir" exibirExcluir="<%=exibirExcluir%>"/>

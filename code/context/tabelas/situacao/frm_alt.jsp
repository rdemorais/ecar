...
<%
	...
	try{
		...
		if(session.getAttribute("objSituacao") != null){
			...
			situacao = (SituacaoSit) situacaoDao.buscar(SituacaoSit.class, Long.valueOf(Pagina.getParamStr(request, "codigo")));
	  	}
		
		_disabled = "";
%>
		<input type="hidden" name="codigo" value="<%=situacao.getCodSit()%>">

...
function validarAlterar(form){
	if(!validaString(form.descricaoCri,"Descrição", true)){
		return(false);
	}
	return(true);
}
...
<form name="form" method="post">
	...
	try{
		...
		CriterioCri criterio = (CriterioCri) criterioDao.buscar(CriterioCri.class, Long.valueOf(Pagina.getParamStr(request, "codigo")));
		_disabled = "";	
		%>
		<input type="hidden" name="codigo" value="<%=criterio.getCodCri()%>">

...
function adicionar(form, codLit, identificacaoLit){
	...
	if (verificaRadios(form, "hidOpcoes") > 1) {
		for (i = 0; i < form.hidOpcoes.length; i++) {
			...
			if (window.opener.adicionaLocal(dados[0], dados[1]))
				inserido = true;
			selecionado = true;
			break;
			}
				...
				<h1>
					...
					<table class="form">
						...
						<tr>
							...
							<td>
								<input type="text" name="identificacaoLit" size="45" maxlength="40" value="<%=Pagina.trocaNull(localItem.getIdentificacaoLit())%>" <%=_disabled%>>
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td>
								<input type="text" name="codIbgeLit" size="8" maxlength="6" value="<%=Pagina.trocaNull(localItem.getCodIbgeLit())%>" <%=_disabled%>>
							</td>
						</tr>
						<tr>
							<td class="label">
							...
							<td>
								<input type="text" name="codPlanejamentoLit" size="8" maxlength="6" value="<%=Pagina.trocaNull(localItem.getCodPlanejamentoLit())%>" <%=_disabled%>>
							</td>
						</tr>
						<tr>
							<td> &nbsp;
